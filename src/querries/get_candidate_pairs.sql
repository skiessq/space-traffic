...
from mart_celestrak_satellites t
join mart_celestrak_satellites c on t.norad_cat_id < c.norad_cat_id
and c.perigee_altitude_km <= t.apogee_altitude_km + $altitude_buffer
and c.apogee_altitude_km >= t.perigee_altitude_km - $altitude_buffer;